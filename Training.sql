...
/****** Object:  Database [Task3]    Script Date: 07-04-2020 14:27:12 ******/
CREATE DATABASE [Task3]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Task3', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Task3.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Task3_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Task3_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [Task3] SET COMPATIBILITY_LEVEL = 110
GO
...
GO
ALTER DATABASE [Task3] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
EXEC sys.sp_db_vardecimal_storage_format N'Task3', N'ON'
GO
USE [Task3]
GO
/****** Object:  Table [dbo].[Training]    Script Date: 07-04-2020 14:27:12 ******/
SET ANSI_NULLS ON
GO
